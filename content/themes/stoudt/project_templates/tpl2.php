...
<div style="background: <?= $background; ?>; margin-top: <?= $margins["top"]; ?>px; margin-bottom: <?= $margins["bottom"]; ?>px;" <?= $background != "transparent" ? "class='tpl-bg-padding'" : "" ?>>
	<div class="<?= !$fullsize ? "container" : "fullsize"; ?> tpl tpl2" >
		<div class="row">
